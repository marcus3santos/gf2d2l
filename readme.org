...
For example: if the quiz grades for the students mentioned in the example above of CSV file example exported by D2L were 70, 100, 65, 0, respectively, then the gf2d2l generated *d2l-quizzes-marks.csv* would contain the following data:following
